...
Route::prefix('/admin')->namespace('App\Http\Controllers\Admin')->group(function () {
    ...
    Route::group(['middleware' => ['admin']], function () { // using our 'admin' guard (which we created in auth.php)
        ...
        Route::get('edit-admin-vendor-details/{id}', 'AdminController@updateAdminVendorDetails');
        Route::post('edit-admin-vendor-details/{id}', 'AdminController@updateAdminVendorDetails');
