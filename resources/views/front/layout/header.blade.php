    ...
    <div class="container-topbar">
        ...
        <div class="menu-topbar-right"><span class="font-xs color-brand-3">Need help? Call Us:</span><span class="font-sm-bold color-success"> + 1800 900</span>
            <div class="dropdown dropdown-language">
                <button class="btn dropdown-toggle" id="dropdownPage" type="button" data-bs-toggle="dropdown" aria-expanded="true" data-bs-display="static"><span class="dropdown-right font-xs color-brand-3">
                        <img src="{{asset('front/new/assets/imgs/template/en.svg')}}" alt="Revira"> English</span></button>
                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownPage" data-bs-popper="static">
                    <li><a class="dropdown-item" href="#"><img src="{{asset('front/new/assets/imgs/template/flag-en.svg')}}" alt="Revira"> English</a></li>
                    <li><a class="dropdown-item" href="#"><img src="{{asset('front/new/assets/imgs/template/flag-fr.svg')}}" alt="Revira"> Français</a></li>
                    <li><a class="dropdown-item" href="#"><img src="{{asset('front/new/assets/imgs/template/flag-es.svg')}}" alt="Revira"> Español</a></li>
                    <li><a class="dropdown-item" href="#"><img src="{{asset('front/new/assets/imgs/template/flag-pt.svg')}}" alt="Revira"> Português</a></li>
                    <li><a class="dropdown-item" href="#"><img src="{{asset('front/new/assets/imgs/template/flag-cn.svg')}}" alt="Revira"> 中国人</a></li>
                </ul>
            </div>
            <div class="dropdown dropdown-language">
    ...
    <div class="container">
        <div class="main-header">
            <div class="header-left">
                <div class="header-logo"><a class="d-flex" href="{{ url('/') }}"><img alt="Revira" src="{{asset('front/new/assets/imgs/logo.png')}}"></a></div>
                    ...
                    <div class="box-header-search">
                        <form class="form-search" action="{{ url('/search-products') }}" method="get">
                            ...
                            <div class="box-keysearch">
                                <input class="form-control font-xs" type="text" name="search" @if (isset($_REQUEST['search']) && !empty($_REQUEST['search'])) value="{{ $_REQUEST['search'] }}" @endif placeholder="Search for items">
                            </div>
                        </form>
                    </div>
                </div>
                <div class="header-nav">
                    <nav class="nav-main-menu d-none d-xl-block">
                        <ul class="main-menu">
                            ...
                            <li><a href="shop-vendor-list.php">Vendors</a></li>
...
<div class="mobile-header-active mobile-header-wrapper-style perfect-scrollbar">
    <div class="mobile-header-wrapper-inner">
        <div class="mobile-header-content-area">
            <div class="mobile-logo"><a class="d-flex" href="index.php"><img alt="Revira" src="{{asset('front/new/assets/imgs/logo.png')}}"></a></div>
            <div class="perfect-scroll">
                ...
                <div class="mobile-account">
                    <div class="mobile-header-top">
                        <div class="user-account"><a href="page-account.php"><img src="{{asset('front/new/assets/imgs/template/ava_1.png')}}" alt="Revira"></a>
                            <div class="content">
    ...
    <ul class="menu-icons hidden">
        @foreach($headerCategories as $category)
            @if($category->subCategories->count())
                <li><a href="javascript:void(0)"><img src="{{ url('front/images/category_images/' . $category['category_image']) }}" alt="Revira"></a></li>
            @endif
        @endforeach
...
<div class="mobile-header-active mobile-header-wrapper-style perfect-scrollbar">
    <div class="mobile-header-wrapper-inner">
        <div class="mobile-header-content-area">
            <div class="mobile-logo"><a class="d-flex" href="index.php"><img alt="Revira" src="assets/imgs/logo.png"></a></div>
            <div class="perfect-scroll">
                <div class="mobile-menu-wrap mobile-header-border">
                    <nav class="mt-15">
                        <ul class="mobile-menu font-heading">
                ...
                <div class="mobile-account">
                    <div class="mobile-header-top">
                        <div class="user-account"><a href="page-account.php"><img src="assets/imgs/template/ava_1.png" alt="Revira"></a>
                            <div class="content">
                                <h6 class="user-name">Hello<span class="text-brand"> Steven !</span></h6>
                                <p class="font-xs text-muted">You have 3 new messages</p>
                            </div>
