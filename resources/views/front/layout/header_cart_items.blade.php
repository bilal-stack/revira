    ...
    <div class="dropdown-cart">
        ...
        <div class="item-cart mb-20">
            ...
            <div class="cart-info">
                ...
                <p><span class="color-brand-2 font-sm-bold">{{ $item['quantity'] }} x ${{ $getDiscountAttributePrice['final_price'] }}</span></p>
            </div>
        </div>
        ...
        <div class="cart-total">
            <div class="row">
                ...
                <div class="col-6"><span class="font-md-bold color-brand-1">${{ $total_price }}</span></div>
            </div>
            <div class="row mt-15">
