    ...
    <div class="container">
                    ...
                    <div class="footer-list">
                        ...
                        <ul>
                            <li>
                                ...
                                <span>Revira - Multi-vendor E-commerce Website</span>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="mailto:info@revira.com">
                                <i class="fas fa-envelope u-s-m-r-9"></i>
                                <span>
                                info@revira.com</span>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="bottom-footer-wrapper">
            ...
            <p class="copyright-text">Copyright &copy; 2022
                <a target="_blank" rel="nofollow" href="#">Revira - Multi-vendor E-commerce Website</a> | All Right Reserved
            </p>
        </div>
    </div>
    <!-- Bottom-Footer /- -->
