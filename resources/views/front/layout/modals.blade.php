                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="product-info">
                            ...
                            <div class="info-by"><span class="bytext color-gray-500 font-xs font-medium">by</span><a class="byAUthor color-gray-900 font-xs font-medium" href="shop-vendor-list.php"> Revira Tech</a>
                                <div class="rating d-inline-block"><img src="assets/imgs/template/icons/star.svg" alt="Revira"><img src="assets/imgs/template/icons/star.svg" alt="Revira"><img src="assets/imgs/template/icons/star.svg" alt="Revira"><img src="assets/imgs/template/icons/star.svg" alt="Revira"><img src="assets/imgs/template/icons/star.svg" alt="Revira"><span class="font-xs color-gray-500 font-medium"> (65 reviews)</span></div>
                            </div>
                            ...
                            <div class="box-product-color mt-10">
                                ...
                                <ul class="list-colors">
                                    <li class="disabled"><img src="assets/imgs/page/product/img-gallery-1.jpg" alt="Revira" title="Pink"></li>
                                    <li><img src="assets/imgs/page/product/img-gallery-2.jpg" alt="Revira" title="Gold"></li>
                                    <li><img src="assets/imgs/page/product/img-gallery-3.jpg" alt="Revira" title="Pink Gold"></li>
                                    <li><img src="assets/imgs/page/product/img-gallery-4.jpg" alt="Revira" title="Silver"></li>
                                    <li class="active"><img src="assets/imgs/page/product/img-gallery-5.jpg" alt="Revira" title="Pink Gold"></li>
                                    <li class="disabled"><img src="assets/imgs/page/product/img-gallery-6.jpg" alt="Revira" title="Black"></li>
                                    <li class="disabled"><img src="assets/imgs/page/product/img-gallery-7.jpg" alt="Revira" title="Red"></li>
                                </ul>
                            </div>
                            ...
                            <div class="buy-product mt-5">
                                ...
                                <div class="box-quantity">
                                    ...
                                    <div class="button-buy"><a class="btn btn-cart" href="{{url('shop-cart')}}">Add to cart</a><a class="btn btn-buy" href="shop-checkout.php">Buy now</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
