        ...
        <div class="breadcrumbs-div">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a class="font-xs color-gray-500" href="{{url('/')}}">Pages</a></li>
                    <li><a class="font-xs color-gray-500" href="{{url('/careers')}}">Careers</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto page-content">
                    <h2 class="text-center mb-20">Work with us</h2><img class="mb-30"
                        src="assets/imgs/page/about/team-2.jpg" alt="Revira">
                    <p>We recognize that poverty has no borders. Neither does excellence. We are continually in search of
                        the brightest, most talented individuals from around the globe.</p>
