                    ...
                    <div class="content-wishlist">
                        <div class="item-wishlist">
                            ...
                            <div class="wishlist-product">
                                <div class="product-wishlist">
                                    <div class="product-image"><a href="{{url('shop-single-product')}}"><img
                                                src="{{asset('front/new/assets/imgs/page/product/img-sub.png')}}" alt="Revira"></a></div>
                                    <div class="product-info"><a href="{{url('shop-single-product')}}">
                            ...
                            <div class="wishlist-status"><span class="btn btn-gray font-md-bold color-brand-3">In
                                    Stock</span></div>
                            <div class="wishlist-action"><a class="btn btn-cart font-sm-bold" href="{{url('cart')}}">Add to
                                    Cart</a></div>
                        ...
                        <div class="item-wishlist">
                            ...
                            <div class="wishlist-product">
                                <div class="product-wishlist">
                                    <div class="product-image"><a href="{{url('shop-single-product')}}"><img
                                                src="{{asset('front/new/assets/imgs/page/product/img-sub2.png')}}" alt="Revira"></a></div>
                                    <div class="product-info"><a href="{{url('shop-single-product')}}">
                                            <h6 class="color-brand-3">Samsung 36&quot; French door 28 cu. ft. Smart Energy
                                                Star Refrigerator </h6>
                                        </a>
                        ...
                        <div class="item-wishlist">
                            ...
                            <div class="wishlist-product">
                                <div class="product-wishlist">
                                    <div class="product-image"><a href="{{url('shop-single-product')}}"><img
                                                src="{{asset('front/new/assets/imgs/page/product/img-sub3.png')}}" alt="Revira"></a></div>
                                    <div class="product-info"><a href="{{url('shop-single-product')}}">
                                            <h6 class="color-brand-3">Samsung 36&quot; French door 28 cu. ft. Smart Energy
                                                Star Refrigerator </h6>
                                        </a>
                        ...
                        <div class="item-wishlist">
                            ...
                            <div class="wishlist-product">
                                <div class="product-wishlist">
                                    <div class="product-image"><a href="{{url('shop-single-product')}}"><img
                                                src="{{asset('front/new/assets/imgs/page/product/img-sub4.png')}}" alt="Revira"></a></div>
                                    <div class="product-info"><a href="{{url('shop-single-product')}}">
                                            <h6 class="color-brand-3">Samsung 36&quot; French door 28 cu. ft. Smart Energy
                                                Star Refrigerator </h6>
                                        </a>
                        ...
                        <div class="item-wishlist">
                            ...
                            <div class="wishlist-product">
                                <div class="product-wishlist">
                                    <div class="product-image"><a href="{{url('shop-single-product')}}"><img
                                                src="{{asset('front/new/assets/imgs/page/product/img-sub5.png')}}" alt="Revira"></a></div>
                                    <div class="product-info"><a href="{{url('shop-single-product')}}">
                                            <h6 class="color-brand-3">Samsung 36&quot; French door 28 cu. ft. Smart Energy
                                                Star Refrigerator </h6>
                                        </a>
