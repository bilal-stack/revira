            ...
            <div class="container">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="info-product">
                                    <div class="row align-items-end">
                                        <div class="col-lg-6 col-md-6 mb-20"><span
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-20"><span
                                                class="font-sm font-medium color-gray-900">Free Delivery<br><span
                                                    class="color-gray-500">Available for all locations.</span><br><span
                                                    class="color-gray-500">Delivery Options & Info</span></span></div>
                                        <div class="col-lg-12 mb-20">
                                            <div class="d-inline-block">
                                                <div class="share-link"><span
                                                        class="font-md-bold color-brand-3 mr-15">Share</span><a
                                                        class="facebook hover-up" href="#"></a><a
                                                        class="printest hover-up" href="#"></a><a
                                                        class="twitter hover-up" href="#"></a><a
                                ...
                                <div class="box-border-product">
                                    <div class="box-product-color">
                                        ...
                                        <ul class="list-colors">
                                            <li class="disabled"><img src="{{ asset('front/new/assets/imgs/page/product/img-thumb.png')}}"
                                                    alt="Revira" title="Pink"></li>
                                            <li><img src="{{ asset('front/new/assets/imgs/page/product/img-thumb.png')}}" alt="Revira"
                                                    title="Gold"></li>
                                            <li><img src="{{ asset('front/new/assets/imgs/page/product/img-thumb.png')}}" alt="Revira"
                                                    title="Pink Gold"></li>
                                            <li><img src="{{ asset('front/new/assets/imgs/page/product/img-thumb.png')}}" alt="Revira"
                                                    title="Silver"></li>
                                            <li class="active"><img src="{{ asset('front/new/assets/imgs/page/product/img-thumb.png')}}"
                                    ...
                                    <div class="button-buy mt-15"><a class="btn btn-cart mb-15" href="shop-cart.php">Add
                                            to cart</a><a class="btn btn-buy" href="shop-checkout.php">Buy now</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-bought-together">
                    <div class="box-product-bought box-product-bought-2">
                        ...
                        <div class="product-bought"><img src="{{ asset('front/new/assets/imgs/page/product/sp4.png')}}" alt="Revira"></div>
                    </div>
