        ...
        <div class="breadcrumbs-div">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a class="font-xs color-gray-500" href="shop-grid-2.php">Electronics</a></li>
                    <li><a class="font-xs color-gray-500" href="shop-grid-2.php">Cell phone</a></li>
                    ...
                    <div class="swiper-wrapper pt-5">
                        <div class="swiper-slide">
                            <div class="card-grid-style-2"><span class="label bg-brand-2">-12%</span>
                                <div class="image-box"><a href="shop-single-product.php"><img
                                            src="assets/imgs/page/homepage2/cat-img-6.png" alt="Revira"></a></div>
                                <div class="info-right"><span class="font-xs color-gray-500">YSSOA
                                        Store</span><br><a class="color-brand-3 font-sm-bold"
                                        href="shop-single-product.php">Chair Mesh Ergonomic Adjustable Swivel Task
                                        Chair with Headrest</a>
                        ...
                        <div class="swiper-slide">
                            <div class="card-grid-style-2"><span class="label bg-brand-2">-17%</span>
                                <div class="image-box"><a href="shop-single-product.php"><img
                                            src="assets/imgs/page/homepage2/cat-img-9.png" alt="Revira"></a></div>
                                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                        class="color-brand-3 font-sm-bold" href="shop-single-product.php">Straight
                                        Talk Samsung Galaxy A03s, 32GB, Black</a>
                                    <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Revira"><img
                                            src="assets/imgs/template/icons/star.svg" alt="Revira"><img
                                            src="assets/imgs/template/icons/star.svg" alt="Revira"><img
                                            src="assets/imgs/template/icons/star.svg" alt="Revira"><img
                        ...
                        <div class="swiper-slide">
                            <div class="card-grid-style-2"><span class="label bg-brand-2">-20%</span>
                                <div class="image-box"><a href="shop-single-product.php"><img
                                            src="assets/imgs/page/homepage2/cat-img-10.png" alt="Revira"></a>
                                </div>
                                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                        class="color-brand-3 font-sm-bold" href="shop-single-product.php">iMac
                        ...
                        <div class="swiper-slide">
                            <div class="card-grid-style-2"><span class="label bg-brand-2">-22%</span>
                                <div class="image-box"><a href="shop-single-product.php"><img
                                            src="assets/imgs/page/homepage2/cat-img-16.png" alt="Revira"></a>
                                </div>
                                <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a
                                        class="color-brand-3 font-sm-bold" href="shop-single-product.php">Apple
                                        Watch Series 8 [GPS 45mm] Smart Watch w/ Midnight Case </a>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="sidebar-ads">
                        <div class="bg-electronic"><span class="big-deal mb-5">Big deal</span>
                ...
                <div class="col-lg-9">
                    <div class="banner-top-gray-100">
                        <div class="banner-ads-top mb-30"><a href="#"><img
                                    src="assets/imgs/page/shop/grid-2/banner.png" alt="Revira"></a></div>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-10 col-lg-9 mb-10 text-lg-end text-center"><span
                                ...
                                <div class="d-inline-block"><span class="font-sm color-gray-500 font-medium">Sort
                                    ...
                                    <div class="dropdown dropdown-sort border-1-right">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownSort"
                                            style="margin: 0px;">
                                            <li><a class="dropdown-item active" href="#">Latest products</a>
                                            </li>
                                ...
                                <div class="d-inline-block"><a class="view-type-grid mr-5 active"
                                        href="shop-grid.php"></a><a class="view-type-list" href="shop-list.php"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                            href="shop-single-product.php"><img
                                                src="assets/imgs/page/homepage1/imgsp3.png" alt="Revira"></a>
                                    </div>
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Dell
                                            Optiplex 9020 Small Form Business Desktop</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                            href="shop-single-product.php"><img
                                                src="assets/imgs/page/homepage1/imgsp4.png" alt="Revira"></a>
                                    </div>
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">HP
                                            24 All-in-One PC, Intel Core i3-1115G4</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                            href="shop-single-product.php"><img
                                                src="assets/imgs/page/homepage1/imgsp5.png" alt="Revira"></a>
                                    </div>
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Gateway
                                            23.8&quot; All-in-one Desktop,
                                            Fully Adjustable</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                            href="shop-single-product.php"><img
                                                src="assets/imgs/page/homepage1/imgsp6.png" alt="Revira"></a>
                                    </div>
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">HP
                                            22 All-in-One PC, Intel Pentium Silver J5040</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                            href="shop-single-product.php"><img
                                                src="assets/imgs/page/homepage1/imgsp7.png" alt="Revira"></a>
                                    </div>
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">HP
                                            Slim Desktop, Intel Celeron J4025, 4GB RAM</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Class 4K UHD
                                            (2160P) LED Roku Smart TV
                                            HDR</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Galaxy Tab
                                            S7 Plus 12.4&quot; 128GB
                                            Mystic Black</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">HP
                                            11.6&quot; Chromebook, AMD A4, 4GB RAM, 32GB Storage</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">MSI
                                            Optix G272 27&quot; Full HD LED Gaming LCD Monitor</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">RCA
                                            43&quot; Class 4K Ultra HD (2160P) HDR Roku Smart</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Bose
                                            Sport Earbuds True Wireless Headphones</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">ASUS
                                            VivoBook 15.6&quot; 1080p PC Laptops, Intel Core i3</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Apple Watch
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Hisense
                                            43&quot; Class 4K UHD LED XClass
                                            Smart TV HDR</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">2025
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Chromecast
                                            with Google TV - Streaming
                                            Entertainment</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">LG
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">HDR Smart
                                            Portable Projector - SP
                                            2025</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Lenovo
                                            Legion 5i 15.6&quot; Laptop,
                                            Intel Core i5</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">2025 Apple
                                            iMac Retina 5K Display 8GB
                                            RAM, 256GB SSD</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Razer
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Seagate
                                            Portable 2TB External Hard
                                            Drive Portable</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">SanDisk
                                            128GB Ultra microSDXC UHS-I
                                            Memory</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Original
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Logitech
                                            C920x HD Pro Webcam, Full
                                            HD</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">HP
                                            24mh FHD Monitor - Computer Monitor with 23.8-Inch</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Logitech
                                            H390 Wired Headset, Stereo
                                            Headphones with Noise</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            ...
                                            Full-Sized Keyboard with Palm</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                            ...
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner">
                                    ...
                                    <div class="info-right"><a class="font-xs color-gray-500"
                                            href="shop-vendor-single.php">Apple</a><br><a
                                            class="color-brand-3 font-sm-bold" href="shop-single-product.php">Logitech
                                            Brio 4K Webcam, Ultra 4K HD
                                            Video Calling 2T Storage</a>
                                        <div class="rating"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                                                alt="Revira"><img src="assets/imgs/template/icons/star.svg"
                ...
                <div class="col-lg-3 order-last order-lg-first">
                    <div class="sidebar-border mb-0">
                        ...
                        <div class="sidebar-content">
                            <ul class="list-nav-arrow">
                                <li><a href="shop-grid.php">Computers &amp; Laptop<span class="number">09</span></a>
                                </li>
                                ...
                                <li><a href="shop-grid.php">Bluetooth devices<span class="number">34</span></a>
                                </li>
                                <li><a href="shop-grid.php">Mouse &amp; Keyboard<span class="number">65</span></a></li>
                                <li><a href="shop-grid.php">Wired Headphone<span class="number">15</span></a>
                                </li>
                                <li><a href="shop-grid.php">Gaming Gatgets<span class="number">76</span></a>
                                </li>
                            ...
                            <div>
                                <div class="collapse" id="moreMenu">
                                    <ul class="list-nav-arrow">
                                        ...
                                        <li><a href="shop-grid.php">Cameras & drones<span class="number">124</span></a>
                                        </li>
                                        <li><a href="shop-grid.php">PC gaming<span class="number">56</span></a>
                                        </li>
                                        <li><a href="shop-grid.php">Smart home<span class="number">87</span></a>
                                        </li>
                                        <li><a href="shop-grid.php">Networking<span class="number">36</span></a>
                                        </li>
                                    </ul>
                    ...
                    <div class="box-slider-item">
                        ...
                        <div class="content-slider mb-50"><a class="btn btn-border mr-5"
                                href="shop-grid.php">Games</a><a class="btn btn-border mr-5"
                                href="shop-grid.php">Electronics</a><a class="btn btn-border mr-5"
                                href="shop-grid.php">Video</a><a class="btn btn-border mr-5"
                                href="shop-grid.php">Cellphone</a><a class="btn btn-border mr-5"
                                href="shop-grid.php">Indoor</a><a class="btn btn-border mr-5" href="shop-grid.php">VGA
                                Card</a><a class="btn btn-border mr-5" href="shop-grid.php">USB</a><a
                                class="btn btn-border mr-5" href="shop-grid.php">Lightning</a><a
                                class="btn btn-border mr-5" href="shop-grid.php">Camera</a><a class="btn btn-border"
                                href="shop-grid.php">Window</a><a class="btn btn-border mr-5" href="shop-grid.php">Air
                                Vent</a><a class="btn btn-border mr-5" href="shop-grid.php">Bedroom</a><a
                                class="btn btn-border mr-5" href="shop-grid.php">Laptop</a><a
                                class="btn btn-border mr-5" href="shop-grid.php">Dashboard</a><a
                                class="btn btn-border mr-5" href="shop-grid.php">Keyboard</a></div>
                    </div>
                    <div class="banner-right h-500 text-center mb-30"><span class="text-no font-11">No.9</span>
                        <h5 class="font-23 mt-20">Sensitive Touch<br class="d-none d-lg-block">without
                            fingerprint</h5>
                        <p class="text-desc font-16 mt-15">Smooth handle and accurate click</p><a
                            href="shop-single-product-2.php">View Details</a>
                    </div>
                </div>
            </div>
        </div>
